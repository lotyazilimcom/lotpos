...
\restrict 4F66ig9qqlVFmwsHEFV942bOOHwzMJ7sabOb7mZXG8lpcCkuq7tk09grWRphXnH
...
CREATE TABLE public.bank_transactions_2024 (
    id integer DEFAULT nextval('public.bank_transactions_id_seq'::regclass) CONSTRAINT bank_transactions_id_not_null NOT NULL,
    company_id text,
    bank_id integer,
    date timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT bank_transactions_date_not_null NOT NULL,
    description text,
    amount numeric(15,2) DEFAULT 0,
    type text,
    location text,
...
CREATE TABLE public.cash_register_transactions_2024 (
    id integer DEFAULT nextval('public.cash_register_transactions_id_seq'::regclass) CONSTRAINT cash_register_transactions_id_not_null NOT NULL,
    company_id text,
    cash_register_id integer,
    date timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT cash_register_transactions_date_not_null NOT NULL,
    description text,
    amount numeric(15,2) DEFAULT 0,
    type text,
    location text,
...
CREATE TABLE public.cat_y2026_m02 (
    id integer DEFAULT nextval('public.current_account_transactions_id_seq'::regclass) CONSTRAINT current_account_transactions_id_not_null NOT NULL,
    current_account_id integer CONSTRAINT current_account_transactions_current_account_id_not_null NOT NULL,
    date timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT current_account_transactions_date_not_null NOT NULL,
    description text,
    amount numeric DEFAULT 0,
    type text,
    source_type text,
...
CREATE TABLE public.credit_card_transactions_2024 (
    id integer DEFAULT nextval('public.credit_card_transactions_id_seq'::regclass) CONSTRAINT credit_card_transactions_id_not_null NOT NULL,
    company_id text,
    credit_card_id integer,
    date timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT credit_card_transactions_date_not_null NOT NULL,
    description text,
    amount numeric(15,2) DEFAULT 0,
    type text,
    location text,
...
CREATE TABLE public.orders_default (
    id integer DEFAULT nextval('public.orders_id_seq'::regclass) CONSTRAINT orders_id_not_null NOT NULL,
    integration_ref text,
    order_no text,
    tur text DEFAULT 'Satış Siparişi'::text CONSTRAINT orders_tur_not_null NOT NULL,
    durum text DEFAULT 'Beklemede'::text CONSTRAINT orders_durum_not_null NOT NULL,
    tarih timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT orders_tarih_not_null NOT NULL,
    cari_id integer,
    cari_kod text,
    cari_adi text,
    ilgili_hesap_adi text,
...
CREATE TABLE public.production_stock_movements_2020 (
    id integer DEFAULT nextval('public.production_stock_movements_id_seq'::regclass) CONSTRAINT production_stock_movements_id_not_null NOT NULL,
    production_id integer CONSTRAINT production_stock_movements_production_id_not_null NOT NULL,
    warehouse_id integer CONSTRAINT production_stock_movements_warehouse_id_not_null NOT NULL,
    quantity numeric DEFAULT 0,
    unit_price numeric DEFAULT 0,
    currency text DEFAULT 'TRY'::text,
    vat_status text DEFAULT 'excluded'::text,
    ...
    consumed_items jsonb,
    related_shipment_ids jsonb,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT production_stock_movements_created_at_not_null NOT NULL
);
...
CREATE TABLE public.quotes_default (
    id integer DEFAULT nextval('public.quotes_id_seq'::regclass) CONSTRAINT quotes_id_not_null NOT NULL,
    integration_ref text,
    quote_no text,
    tur text DEFAULT 'Satış Teklifi'::text CONSTRAINT quotes_tur_not_null NOT NULL,
    durum text DEFAULT 'Beklemede'::text CONSTRAINT quotes_durum_not_null NOT NULL,
    tarih timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT quotes_tarih_not_null NOT NULL,
    cari_id integer,
    cari_kod text,
    cari_adi text,
    ilgili_hesap_adi text,
...
CREATE TABLE public.stock_movements_2025 (
    id integer DEFAULT nextval('public.stock_movements_id_seq'::regclass) CONSTRAINT stock_movements_id_not_null NOT NULL,
    product_id integer,
    warehouse_id integer,
    shipment_id integer,
    quantity numeric DEFAULT 0,
    is_giris boolean DEFAULT true CONSTRAINT stock_movements_is_giris_not_null NOT NULL,
    unit_price numeric DEFAULT 0,
    currency_code text DEFAULT 'TRY'::text,
    currency_rate numeric DEFAULT 1,
    vat_status text DEFAULT 'excluded'::text,
    movement_date timestamp without time zone CONSTRAINT stock_movements_movement_date_not_null NOT NULL,
    description text,
    movement_type text,
    created_by text,
    integration_ref text,
    running_cost numeric DEFAULT 0,
    running_stock numeric DEFAULT 0,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT stock_movements_created_at_not_null NOT NULL
);
...
CREATE TABLE public.user_transactions_2024 (
    id text CONSTRAINT user_transactions_id_not_null NOT NULL,
    company_id text,
    user_id text,
    date timestamp without time zone DEFAULT CURRENT_TIMESTAMP CONSTRAINT user_transactions_date_not_null NOT NULL,
    description text,
    debt numeric(15,2) DEFAULT 0,
    credit numeric(15,2) DEFAULT 0,
    type text
...
\unrestrict 4F66ig9qqlVFmwsHEFV942bOOHwzMJ7sabOb7mZXG8lpcCkuq7tk09grWRphXnH
