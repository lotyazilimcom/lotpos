...
class _MyAppState extends State<MyApp>
  ...
  void onWindowClose() async {
    ...
    try {
      await LisansServisi().kapanisOfflineSinyaliGonder().timeout(
...
class _HomePageState extends State<HomePage> {
  ...
  void _ilkAnaSayfaSekmesiniHazirla() {
    final mevcutAnaSayfaTabIndex = _acikTablar.indexWhere(
      (tab) => tab.menuIndex == 0,
    );

    if (mevcutAnaSayfaTabIndex != -1) {
      _aktifTabIndex = mevcutAnaSayfaTabIndex;
      _selectedIndex = 0;
      return;
    }

    final anaSayfaTabi = _tabVeriOlustur(0);
    if (anaSayfaTabi == null) return;

    _acikTablar.add(anaSayfaTabi);
    _aktifTabIndex = 0;
    _selectedIndex = 0;
  }
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final double deviceBottomInset = MediaQuery.paddingOf(context).bottom;
          final bool usesCompactMobileBottomInset = const {
            1,
            2,
            3,
            5,
          ...
          final double bottomInset = isTablet ? deviceBottomInset : 0.0;
          final double sidebarBottomOverflow =
              !isTablet && !usesCompactMobileBottomInset
              ? deviceBottomInset
              : 0.0;
                            ...
                            return Container(
                              ...
                              padding: isAyarSayfasiMobile
                                  ...
                                  : EdgeInsets.fromLTRB(
                                      ...
                                      16,
                                      16,
                                      usesCompactMobileBottomInset ? 0 : 16,
                                    ),
                              child: AnimatedSwitcher(
                                duration: const Duration(milliseconds: 250),
                                child: KeyedSubtree(
          ...
          final safeChild = isTablet || usesCompactMobileBottomInset
          ...
          return SafeArea(
            bottom: !isTablet && !usesCompactMobileBottomInset,
            child: safeChild,
          );
        },
      ),
