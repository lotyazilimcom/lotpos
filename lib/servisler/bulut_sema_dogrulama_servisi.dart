...
class BulutSemaDogrulamaServisi {
  ...
  static const List<String> _requiredIndexes = <String>[
    ...
    'idx_banks_search_tags_fts_gin',
    'idx_bt_bank_id',
    'idx_bt_search_tags_gin',
    'idx_bt_search_tags_fts_gin',
    'idx_bt_created_at',
    ...
    'idx_cheques_search_tags_fts_gin',
    'idx_cheques_type',
    'idx_credit_cards_search_tags_gin',
    'idx_credit_cards_search_tags_fts_gin',
    ...
    'idx_depots_search_tags_fts_gin',
    'idx_expense_items_expense_id',
    'idx_expense_items_search_tags_gin',
    'idx_expense_items_search_tags_fts_gin',
    ...
    'idx_expenses_search_tags_fts_gin',
    ...
    'idx_note_transactions_search_tags_fts_gin',
    ...
    'idx_notes_search_tags_fts_gin',
    'idx_notes_type',
    'idx_order_items_search_tags_gin',
    'idx_order_items_search_tags_fts_gin',
    ...
    'idx_productions_search_tags_fts_gin',
    ...
    'idx_psm_search_tags_fts_gin',
    'idx_psm_warehouse_id',
    'idx_quote_items_search_tags_gin',
    'idx_quote_items_search_tags_fts_gin',
