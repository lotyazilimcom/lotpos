...
class BulutSemaDogrulamaServisi {
  ...
  static final List<String> _requiredIndexes =
      List<String>.unmodifiable(<String>[
        ...
        'idx_cat_date_btree',
        'idx_cat_ref',
        'idx_cat_search_tags_gin',
        'idx_cct_created_at',
        'idx_cct_credit_card_id',
        'idx_cct_date',
        'idx_cct_integration_ref',
        'idx_cct_search_tags_gin',
        'idx_cct_type',
        ...
        'idx_expense_items_search_tags_gin',
        ...
        'idx_notes_type',
        'idx_order_items_search_tags_gin',
        ...
        'idx_pd_product_id',
        'idx_pd_product_sold_id',
        'idx_pd_search_tags_gin',
        ...
        'idx_psm_search_tags_gin',
        'idx_psm_warehouse_id',
        'idx_quote_items_search_tags_gin',
        ...
        ...BuyukOlcekAramaBootstrapSpec.searchTables.map(
          BuyukOlcekAramaBootstrapSpec.searchFtsIndexNameForTable,
        ),
        'idx_settings_users_search_tags_gin',
        'idx_settings_users_search_tags_fts_gin',
        'idx_settings_user_tx_search_tags_gin',
        'idx_settings_user_tx_search_tags_fts_gin',
        'idx_settings_roles_search_tags_gin',
        'idx_settings_roles_search_tags_fts_gin',
        'idx_settings_company_search_tags_gin',
        'idx_settings_company_search_tags_fts_gin',
        'idx_settings_users_hire_date_sort',
        'idx_settings_users_role_active_id',
        'idx_settings_roles_name_id',
        'idx_settings_company_kod_id',
        'idx_settings_company_ad_id',
      ]);

  static final List<String> _requiredHotPathIndexes = List<String>.unmodifiable(
    _requiredIndexes,
  );
  ...
  static const List<String> _requiredFunctions = <String>[
    ...
    'normalize_text',
    'update_current_account_transaction_search_tags',
    'update_account_metadata',
    'update_bank_search_tags',
    'update_cash_register_search_tags',
    'update_credit_card_search_tags',
    'update_depots_search_tags',
    'update_product_devices_last_tx_from_shipments',
    'update_product_devices_search_tags',
    'update_product_metadata',
    'update_production_metadata',
    'update_production_stock_movements_search_tags',
    'update_productions_search_tags',
    'update_shipments_search_tags',
    'update_stock_movements_search_tags',
    'update_table_counts',
  ];

  static const List<_TriggerRef> _requiredTriggers = <_TriggerRef>[
    _TriggerRef(
      'trg_update_current_account_transaction_search_tags',
      'current_account_transactions',
    ),
    ...
    _TriggerRef('trg_update_product_devices_search_tags', 'product_devices'),
    _TriggerRef(
      'trg_update_product_devices_last_tx_from_shipments',
      'shipments',
    ),
    _TriggerRef('trg_update_shipments_search_tags', 'shipments'),
    _TriggerRef('trg_update_stock_movements_search_tags', 'stock_movements'),
  ];
  ...
  static const List<_ColumnRef> _requiredColumns = <_ColumnRef>[
    ...
    _ColumnRef('bank_transactions', 'search_tags'),
    ...
    _ColumnRef('cash_register_transactions', 'search_tags'),
    ...
    _ColumnRef('credit_card_transactions', 'search_tags'),
    ...
    _ColumnRef('current_account_transactions', 'search_tags'),
    ...
    _ColumnRef('product_devices', 'last_tx_shipment_id'),
    _ColumnRef('product_devices', 'last_tx_type'),
    _ColumnRef('product_devices', 'sale_ref'),
    _ColumnRef('product_devices', 'search_tags'),
    _ColumnRef('production_stock_movements', 'consumed_items'),
    _ColumnRef('production_stock_movements', 'related_shipment_ids'),
    _ColumnRef('production_stock_movements', 'search_tags'),
    ...
    _ColumnRef('shipments', 'search_tags'),
    ...
    _ColumnRef('stock_movements', 'search_tags'),
  ...
  Future<bool> bulutSemasiHazirMi({
    ...
    if (!VeritabaniYapilandirma.cloudAccessReady) return false;
