...
class BankaParaGirSayfasi extends StatefulWidget {
  final int? islemId;
  final Map<String, dynamic>? initialData;
  final BankaModel banka;

  const BankaParaGirSayfasi({
    super.key,
    required this.banka,
    this.islemId,
    this.initialData,
  ...
  @override
  State<BankaParaGirSayfasi> createState() => _BankaParaGirSayfasiState();
}

class _BankaParaGirSayfasiState extends State<BankaParaGirSayfasi> {
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                tr(
                  widget.islemId != null
                      ? 'banks.transaction.deposit.edit_title'
                      : 'banks.transaction.deposit.title',
                ),
        ...
        return Column(
          children: [
            ...
            _buildDropdown<String>(
              ...
              label: tr('banks.transaction.source'),
            ...
            AkilliAciklamaInput(
              ...
              category: 'bank_deposit_description',
              color: optionalColor,
              defaultItems: [
                tr('smart_select.bank_deposit.desc.1'),
                tr('smart_select.bank_deposit.desc.2'),
                tr('smart_select.bank_deposit.desc.3'),
                tr('smart_select.bank_deposit.desc.4'),
                tr('smart_select.bank_deposit.desc.5'),
              ],
            ),
          ],
        );
