    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final TextStyle balanceStyle = TextStyle(
          ...
          color: bakiye >= 0 ? Colors.red.shade700 : Colors.green.shade700,
        );
          ...
          return Column(
            ...
            children: [
              ...
              Text(
                ...
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
                style: customValueStyle ?? valueStyle,
              ),
            ],
          );
        }
