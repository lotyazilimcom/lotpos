...
class _GenisletilebilirPrintPreviewScreenState
  ...
  void initState() {
    super.initState();
    _showDetails =
        widget.initialShowDetails || widget.data.any(_hasExpandedDetailContent);
  ...
  bool _hasExpandedDetailContent(ExpandableRowData row) {
    return row.isSourceExpanded &&
        (row.details.isNotEmpty ||
            row.transactions != null ||
            (row.imageUrls?.isNotEmpty ?? false) ||
            (row.resolvedImages?.isNotEmpty ?? false));
  }
  ...
  Future<void> _generatePdf() async {
    ...
    List<ExpandableRowData> filteredData = widget.data.map((row) {
      ...
      return ExpandableRowData(
        ...
        isSourceExpanded: row.isSourceExpanded,
      );
    }).toList();
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FilledButton(
                        onPressed: _printingDisabled ? null : _handlePrint,
