...
class _SatisSonrasiYazdirSayfasiState extends State<SatisSonrasiYazdirSayfasi> {
  ...
  Widget _buildFooter(Color primaryColor) {
    ...
    final bool printDisabled = _printingDisabled;
    return Container(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: _secilenSablon == null || printDisabled
                            ? null
                            : _yazdir,
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          readOnly: isDate,
          mouseCursor: ((isDate) && ((enabled ? onTap : null) != null))
