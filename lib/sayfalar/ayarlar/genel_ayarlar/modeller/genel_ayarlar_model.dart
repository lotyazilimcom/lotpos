class GenelAyarlarModel {
  ...
  String perakendeNakitIslemeYeri;

  /// Seçilen hesap kodu ('' = varsayılan)
  String perakendeNakitIslemeHesapKodu;

  /// 'cash' | 'bank' | 'credit_card'
  String perakendeHavaleIslemeYeri;

  /// Seçilen hesap kodu ('' = varsayılan)
  String perakendeHavaleIslemeHesapKodu;

  /// 'cash' | 'bank' | 'credit_card'
  String perakendeKrediKartiIslemeYeri;

  /// Seçilen hesap kodu ('' = varsayılan)
  String perakendeKrediKartiIslemeHesapKodu;

  /// Kredi kartı satışlarını varsayılan bankaya işle (POS tahsilatı gibi)
  bool perakendeKrediKartiSatisiBankaHesabinaIslensin;
  ...
  GenelAyarlarModel({
    ...
    this.perakendeNakitIslemeYeri = 'cash',
    this.perakendeNakitIslemeHesapKodu = '',
    this.perakendeHavaleIslemeYeri = 'bank',
    this.perakendeHavaleIslemeHesapKodu = '',
    this.perakendeKrediKartiIslemeYeri = 'credit_card',
    this.perakendeKrediKartiIslemeHesapKodu = '',
    this.perakendeKrediKartiSatisiBankaHesabinaIslensin = false,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'perakendeNakitIslemeYeri': perakendeNakitIslemeYeri,
      'perakendeNakitIslemeHesapKodu': perakendeNakitIslemeHesapKodu,
      'perakendeHavaleIslemeYeri': perakendeHavaleIslemeYeri,
      'perakendeHavaleIslemeHesapKodu': perakendeHavaleIslemeHesapKodu,
      'perakendeKrediKartiIslemeYeri': perakendeKrediKartiIslemeYeri,
      'perakendeKrediKartiIslemeHesapKodu': perakendeKrediKartiIslemeHesapKodu,
      'perakendeKrediKartiSatisiBankaHesabinaIslensin':
          perakendeKrediKartiSatisiBankaHesabinaIslensin ? 1 : 0,
  ...
  factory GenelAyarlarModel.fromMap(Map<String, dynamic> map) {
    return GenelAyarlarModel(
      ...
      perakendeNakitIslemeYeri:
          map['perakendeNakitIslemeYeri']?.toString() ?? 'cash',
      perakendeNakitIslemeHesapKodu:
          map['perakendeNakitIslemeHesapKodu']?.toString() ?? '',
      perakendeHavaleIslemeYeri:
          map['perakendeHavaleIslemeYeri']?.toString() ?? 'bank',
      perakendeHavaleIslemeHesapKodu:
          map['perakendeHavaleIslemeHesapKodu']?.toString() ?? '',
      perakendeKrediKartiIslemeYeri:
          map['perakendeKrediKartiIslemeYeri']?.toString() ?? 'credit_card',
      perakendeKrediKartiIslemeHesapKodu:
          map['perakendeKrediKartiIslemeHesapKodu']?.toString() ?? '',
      perakendeKrediKartiSatisiBankaHesabinaIslensin:
          (map['perakendeKrediKartiSatisiBankaHesabinaIslensin'] ?? 0) == 1,
