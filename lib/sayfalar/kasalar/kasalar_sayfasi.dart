...
class _KasalarSayfasiState extends State<KasalarSayfasi> {
  ...
  Future<void> _fetchKasalar({bool showLoading = true}) async {
    ...
    try {
      ...
      final depolar = await KasalarVeritabaniServisi().kasalariGetir(
        sayfa: _currentPage,
      ...
      final totalFuture = KasalarVeritabaniServisi().kasaSayisiGetir(
      ...
      unawaited(
        totalFuture
            ...
            .catchError((e) {
              debugPrint('Kasa toplam sayısı güncellenemedi: $e');
            }),
      );
  ...
  Widget _buildMobileView(List<KasaModel> filteredKasalar) {
    ...
    final int endRecord = totalRecords == 0
        ? 0
        : (startRecordIndex + filteredKasalar.length).clamp(0, totalRecords);
