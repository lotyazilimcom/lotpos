...
class SenetCiroSayfasi extends StatefulWidget {
  ...
  const SenetCiroSayfasi({super.key, required this.senet, this.transaction});

  @override
  State<SenetCiroSayfasi> createState() => _SenetCiroSayfasiState();
}

class _SenetCiroSayfasiState extends State<SenetCiroSayfasi> {
  ...
  Future<void> _handleEndorse() async {
    ...
    if (_accountCodeController.text == widget.senet.cariKod) {
      MesajYardimcisi.hataGoster(
        context,
        tr('notes.endorse.error.self_endorse'),
      );
      return;
    }
    ...
    try {
      ...
      if (widget.transaction != null) {
        ...
        await SenetlerVeritabaniServisi().senetCiroEt(
      ...
      child: FocusTraversalGroup(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              widget.transaction != null
                  ? tr('notes.actions.edit_endorse_title')
                  : tr('notes.endorse.title'),
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildSection(
                              theme,
                              title: tr('notes.endorse.endorsement_info'),
          ...
          children: [
            ...
            _buildRow(isWide, [
              _buildAutocompleteField(
                ...
                label: tr('notes.endorse.customer_code'),
                isRequired: true,
                color: requiredColor,
              ...
              _buildTextField(
                ...
                label: tr('notes.endorse.customer_name'),
                isRequired: true,
                color: requiredColor,
                readOnly: true,
            ...
            _buildRow(isWide, [
              AkilliAciklamaInput(
                ...
                label: tr('notes.endorse.description'),
                category: 'note_endorse_description',
                color: optionalColor,
                defaultItems: [
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            _buildDialogHeader(
              tr('notes.endorse.select_customer'),
              tr('common.search'),
            ),
