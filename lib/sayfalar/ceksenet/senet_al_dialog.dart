...
class SenetAlDialog extends StatefulWidget {
  const SenetAlDialog({super.key, this.senet, this.initialSenetNo});

  final SenetModel? senet;
  final String? initialSenetNo;

  @override
  State<SenetAlDialog> createState() => _SenetAlDialogState();
}

class _SenetAlDialogState extends State<SenetAlDialog> {
                          ...
                          children: [
                            ...
                            Text(
                              widget.senet != null
                                  ...
                                  : tr('notes.form.receive.subtitle'),
                              style: const TextStyle(
                                fontSize: 14,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 22),
                          // Senet Numarası (Tek alan, tam genişlik)
                          ...
                          AkilliAciklamaInput(
                            ...
                            category: 'note_receive_description',
                            color: _primaryColor,
