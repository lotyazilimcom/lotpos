...
class CekVerDialog extends StatefulWidget {
  ...
  @override
  State<CekVerDialog> createState() => _CekVerDialogState();
}

class _CekVerDialogState extends State<CekVerDialog> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AkilliAciklamaInput(
                            ...
                            category: 'check_issue_description',
                            color: _primaryColor,
