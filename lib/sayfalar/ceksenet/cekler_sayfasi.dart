...
class _CeklerSayfasiState extends State<CeklerSayfasi> {
  ...
  Future<void> _fetchCekler({bool showLoading = true}) async {
    ...
    try {
      final depolar = await CeklerVeritabaniServisi().cekleriGetir(
        sayfa: _currentPage,
      ...
      final totalFuture = CeklerVeritabaniServisi().cekSayisiGetir(
      ...
      unawaited(
        totalFuture
            ...
            .catchError((e) {
              debugPrint('Çek toplam sayısı güncellenemedi: $e');
            }),
      );
