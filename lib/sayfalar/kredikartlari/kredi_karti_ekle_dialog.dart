...
class _KrediKartiEkleDialogState extends State<KrediKartiEkleDialog> {
  ...
  void initState() {
    super.initState();
    final krediKarti = widget.krediKarti;
    _kodController = TextEditingController(
      text: krediKarti?.kod ?? widget.initialCode ?? '',
    );
    _adController = TextEditingController(text: krediKarti?.ad ?? '');
    _subeKoduController = TextEditingController(
      text: krediKarti?.subeKodu ?? '',
    );
    _subeAdiController = TextEditingController(text: krediKarti?.subeAdi ?? '');
    _hesapNoController = TextEditingController(text: krediKarti?.hesapNo ?? '');
    _ibanController = TextEditingController(text: krediKarti?.iban ?? '');
    _bilgi1Controller = TextEditingController(text: krediKarti?.bilgi1 ?? '');
  ...
  Future<void> _kaydet() async {
    ...
    final isDuplicate = await KrediKartlariVeritabaniServisi()
        .krediKartiKoduVarMi(
          _kodController.text.trim(),
          haricId: widget.krediKarti?.id,
        );
    ...
    final KrediKartiModel sonuc = KrediKartiModel(
      id: widget.krediKarti?.id ?? 0,
      ...
      bakiye: widget.krediKarti?.bakiye ?? 0.0,
      aktifMi: _aktifMi,
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  widget.krediKarti != null
                                      ? tr('creditcards.form.edit.title')
                                      : tr('creditcards.form.add.title'),
                                  style: TextStyle(
                                ...
                                Text(
                                  widget.krediKarti != null
                                      ? tr('creditcards.form.edit.subtitle')
                                      : tr('creditcards.form.add.subtitle'),
                                  style: TextStyle(
                            ...
                            LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                final firstField = _buildUnderlinedField(
                                  label: tr('creditcards.form.code.label'),
                                  hint: tr('creditcards.form.code.hint'),
                                ...
                                final secondField = _buildUnderlinedField(
                                  label: tr('creditcards.form.name.label'),
                                  hint: tr('creditcards.form.name.hint'),
                            ...
                            LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                final info1 = _buildUnderlinedField(
                                  label: tr('creditcards.form.info1.label'),
                                  hint: tr('creditcards.form.info1.hint'),
                                ...
                                final info2 = _buildUnderlinedField(
                                  label: tr('creditcards.form.info2.label'),
                                  hint: tr('creditcards.form.info2.hint'),
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final saveButton = ElevatedButton(
                          ...
                          child: Text(
                            widget.krediKarti != null
                                ? tr('creditcards.form.update')
                                : tr('creditcards.form.save'),
                            style: TextStyle(
                              fontSize: isCompact ? 13 : 14,
                              fontWeight: FontWeight.w700,
                            ),
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(
              tr('creditcards.form.currency.label'),
              style: const TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w700,
                color: Colors.red,
