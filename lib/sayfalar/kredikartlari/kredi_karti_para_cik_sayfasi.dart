...
class KrediKartiParaCikSayfasi extends StatefulWidget {
  final KrediKartiModel krediKarti;

  final int? islemId;
  final Map<String, dynamic>? initialData;

  const KrediKartiParaCikSayfasi({
    super.key,
  ...
  @override
  State<KrediKartiParaCikSayfasi> createState() =>
      _KrediKartiParaCikSayfasiState();
}

class _KrediKartiParaCikSayfasiState extends State<KrediKartiParaCikSayfasi> {
        ...
        if (!isVirman) {
          ...
          if (_selectedSource == 'cash') {
            await KasalarVeritabaniServisi().kasaIslemEkle(
              ...
              aciklama: _descriptionController.text,
              tarih: _selectedDate,
              cariTuru: tr('cashregisters.transaction.type.credit_card'),
              cariKodu: widget.krediKarti.kod,
              cariAdi: widget.krediKarti.ad,
              kullanici: currentUser,
              cariEntegrasyonYap: false,
              entegrasyonRef: ref,
            );
            ...
            await BankalarVeritabaniServisi().bankaIslemEkle(
              ...
              aciklama: _descriptionController.text,
              tarih: _selectedDate,
              cariTuru: tr('banks.transaction.type.credit_card'),
              cariKodu: widget.krediKarti.kod,
              cariAdi: widget.krediKarti.ad,
              kullanici: currentUser,
              cariEntegrasyonYap: false,
            ...
            await KrediKartlariVeritabaniServisi().krediKartiIslemEkle(
              ...
              aciklama: _descriptionController.text,
              tarih: _selectedDate,
              cariTuru: tr('creditcards.transaction.type.credit_card'),
              cariKodu: widget.krediKarti.kod,
              cariAdi: widget.krediKarti.ad,
              kullanici: currentUser,
              cariEntegrasyonYap: false,
        ...
        child: Focus(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                tr('creditcards.transaction.withdraw.title'),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildSection(
                                theme,
                                title: tr(
                                  'creditcards.transaction.withdraw.title',
                                ),
        ...
        return Column(
          children: [
            ...
            _buildDropdown<String>(
              ...
              label: tr('creditcards.transaction.destination'),
            ...
            AkilliAciklamaInput(
              ...
              category: 'credit_card_withdrawal_description',
              color: optionalColor,
              defaultItems: [
                tr('smart_select.credit_card_withdraw.desc.1'),
                tr('smart_select.credit_card_withdraw.desc.2'),
                tr('smart_select.credit_card_withdraw.desc.3'),
                tr('smart_select.credit_card_withdraw.desc.4'),
                tr('smart_select.credit_card_withdraw.desc.5'),
              ],
            ),
          ],
        );
