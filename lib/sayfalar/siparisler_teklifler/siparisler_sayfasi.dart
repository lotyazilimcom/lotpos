...
class _SiparislerSayfasiState extends State<SiparislerSayfasi> {
  ...
  Future<void> _fetchSiparisler({
    ...
    try {
      ...
      final lastId =
          (_currentPage == _previousPage + 1 && _siparisler.isNotEmpty)
          ? _siparisler.last.id
          : null;

      final countFuture = servis.siparisSayisiGetir(
      ...
      final results = await servis.siparisleriGetir(
        sayfa: _currentPage,
      ...
      unawaited(
        countFuture
            ...
            .catchError((e) {
              debugPrint('Sipariş toplam sayısı güncellenemedi: $e');
            }),
      );
  ...
  Widget _buildMobileView() {
    ...
    final int showingEnd = _totalRecords == 0
        ? 0
        : (((currentPage - 1) * safeRowsPerPage) + _siparisler.length).clamp(
            0,
            _totalRecords,
          );
      ...
      child: MouseRegion(cursor: SystemMouseCursors.click, hitTestBehavior: HitTestBehavior.deferToChild, child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.print_outlined, size: 18, color: Colors.black87),
              const SizedBox(width: 8),
              Text(
                _selectedIds.isNotEmpty ||
                        _selectedDetailIds.values.any((s) => s.isNotEmpty)
      ...
      child: MouseRegion(cursor: SystemMouseCursors.click, hitTestBehavior: HitTestBehavior.deferToChild, child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.add_shopping_cart, size: 16, color: Color(0xFF2C3E50)),
              const SizedBox(width: 8),
              Text(
                tr('products.add'),
                style: const TextStyle(
  ...
  void _updateOrderItem(
    ...
    try {
      ...
      final count = await SiparislerVeritabaniServisi().siparisSayisiGetir(
        aramaTerimi: _searchQuery,
        tur: _selectedType,
        baslangicTarihi: _startDate,
        bitisTarihi: _endDate,
