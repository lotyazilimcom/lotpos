...
class TeklifEkleSayfasi extends StatefulWidget {
  final String tur;
  final TeklifModel? initialQuote;
  const TeklifEkleSayfasi({super.key, required this.tur, this.initialQuote});

  @override
  State<TeklifEkleSayfasi> createState() => _TeklifEkleSayfasiState();
}

class _TeklifEkleSayfasiState extends State<TeklifEkleSayfasi> {
  ...
  void initState() {
    ...
    if (widget.initialQuote != null) {
      ...
      _selectedTarih = quote.tarih;
      _tarihController.text = DateFormat('dd.MM.yyyy').format(_selectedTarih);
      _aciklamaController.text = quote.aciklama;
      _aciklama2Controller.text = quote.aciklama2;
      _selectedGecerlilikTarihi = quote.gecerlilikTarihi;
      _selectedParaBirimi = quote.paraBirimi;
      ...
      for (final item in quote.urunler) {
        _eklenenUrunler.add({
          'urunId': item.urunId,
  ...
  Future<void> _handleSave() async {
    if (_eklenenUrunler.isEmpty) {
      MesajYardimcisi.uyariGoster(
        context,
        tr('quotes.form.error.items_required'),
      );
      return;
    }

    if (_tarihController.text.isEmpty) {
      MesajYardimcisi.hataGoster(context, tr('quotes.complete.error.no_date'));
      return;
    }
    ...
    if (sonToplam < 0) {
      MesajYardimcisi.hataGoster(
        context,
        tr('quotes.complete.error.no_final_total'),
      );
      return;
    }
    ...
    try {
      // Akıllı açıklama önerilerini kaydet
      final settingsService = AyarlarVeritabaniServisi();
      if (_aciklamaController.text.isNotEmpty) {
        await settingsService.aciklamaEkle(
          'quote_description',
          _aciklamaController.text,
        );
      }
      if (_aciklama2Controller.text.isNotEmpty) {
        await settingsService.aciklamaEkle(
          'quote_description_2',
          _aciklama2Controller.text,
        );
      }
      ...
      if (widget.initialQuote != null) {
        await TekliflerVeritabaniServisi().teklifGuncelle(
          ...
          tur: widget.tur,
          durum: widget.initialQuote!.durum,
        ...
        await TekliflerVeritabaniServisi().teklifEkle(
          tur: widget.tur,
          durum: 'Beklemede',
          tarih: _selectedTarih,
          cariId: _selectedCari?.id,
      ...
      if (!mounted) return;
      MesajYardimcisi.basariGoster(context, tr('quotes.save_success'));
  ...
  void _addUrunToList() {
    if (_selectedUrun == null) {
      MesajYardimcisi.uyariGoster(context, tr('quotes.error.select_product'));
      return;
    }
    ...
    if (miktar <= 0) {
      MesajYardimcisi.uyariGoster(context, tr('quotes.error.invalid_quantity'));
      return;
    }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSection(
                            theme,
                            title: tr('quotes.info_section'),
                            child: _buildQuoteInfoSection(theme),
                          ...
                          _buildSection(
                            theme,
                            title: tr('quotes.product_section'),
                          ...
                          _buildSection(
                            theme,
                            title:
                                '${tr('quotes.items_section')} (${_eklenenUrunler.length})',
                          ...
                          _buildSection(
                            theme,
                            title: tr('quotes.complete.section.document'),
                          ...
                          _buildSection(
                            theme,
                            title: tr('quotes.complete.section.totals'),
    ...
    return AppBar(
      ...
      title: Text(
        widget.initialQuote != null
            ? tr('quotes.edit_title')
            : tr('quotes.create_title'),
  ...
  Widget _buildQuoteInfoSection(ThemeData theme) {
    ...
    return Column(
      children: [
        _buildDropdown<DepoModel>(
          value: _selectedDepo,
          label: tr('quotes.field.warehouse'),
          items: _depolar,
          itemLabel: (d) => d.ad,
        ...
        // Cari Hesap Bul - satis_yap_sayfasi.dart ile birebir aynı yapı
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
  ...
  Widget _buildBelgeBilgileriSectionStep2(
    ...
    final firstDescription = AkilliAciklamaInput(
      ...
      label: tr('quotes.complete.field.description'),
      category: 'quote_description',
      defaultItems: [
    ...
    final secondDescription = AkilliAciklamaInput(
      ...
      label: tr('quotes.complete.field.description2'),
      category: 'quote_description_2',
      defaultItems: [
          ...
          children: [
            if (stack) ...[
              _buildDateFieldStyled(
                ...
                label: tr('quotes.complete.field.date'),
                isRequired: true,
                color: requiredColor,
              ...
              _buildDateFieldStyled(
                ...
                label: tr('quotes.complete.field.validity_date'),
                color: optionalColor,
    ...
    return Column(
      children: [
        _buildTutarFieldStyled(
          ...
          label: tr('quotes.complete.field.grand_total'),
        ...
        _buildTutarFieldStyled(
          ...
          label: tr('quotes.complete.field.rounding'),
          currency: _selectedParaBirimi,
          color: color,
        ...
        _buildTutarFieldStyled(
          ...
          label: tr('quotes.complete.field.final_total'),
          currency: _selectedParaBirimi,
          color: requiredColor,
          readOnly: true,
          isHighlighted: true,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      Text(
                        tr('quotes.form.select_account_optional'),
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          color: Color(0xFF606368),
