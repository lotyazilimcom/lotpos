...
class _TekliflerSayfasiState extends State<TekliflerSayfasi> {
  ...
  Future<void> _fetchTeklifler({
    ...
    try {
      ...
      if (usePrimarySearch) {
        ...
        results = await servis.teklifleriGetir(
          sayfa: _currentPage,
      ...
      final List<TeklifModel> display = results;
  ...
  Widget _buildMobileView() {
    ...
    final int showingStart = _teklifler.isEmpty ? 0 : startRecordIndex + 1;
    final int endRecord = _teklifler.isEmpty
        ? 0
        : startRecordIndex + _teklifler.length;
    final String totalLabel = _teklifler.isEmpty
        ? '0'
  ...
  Future<void> _handlePrint() async {
    ...
    try {
      ...
      for (var i = 0; i < dataToProcess.length; i++) {
        ...
        final int safeRowsPerPage = _rowsPerPage <= 0 ? 25 : _rowsPerPage;
        final int startRecordIndex = (_currentPage - 1) * safeRowsPerPage;
        final int originIndex = _teklifler.indexWhere((o) => o.id == order.id);
        final int orderNo =
        ...
        final isExpanded =
            ...
            _mobileExpandedQuoteIds.contains(order.id);
