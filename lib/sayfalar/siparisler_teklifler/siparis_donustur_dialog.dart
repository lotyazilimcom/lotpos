...
import '../siparisler_teklifler/modeller/siparis_model.dart';
...
class SiparisDonusturDialog extends StatefulWidget {
  final SiparisModel siparis;

  const SiparisDonusturDialog({super.key, required this.siparis});

  @override
  State<SiparisDonusturDialog> createState() => _SiparisDonusturDialogState();
}

class _SiparisDonusturDialogState extends State<SiparisDonusturDialog> {
  ...
  void initState() {
    super.initState();
    _selectedParaBirimi = widget.siparis.paraBirimi;
    ...
    _cariAramaController = TextEditingController(
      text: widget.siparis.cariAdi ?? '',
    );

    _yukle().then((_) {
      if (widget.siparis.cariId != null) {
        _loadInitialCari();
      }
    });
  }
  ...
  // _onCariSearch kaldırıldı çünkü Autocomplete optionsBuilder kullanıyor.

  // _onDonustur kaldırıldı, _onCurrencyConversionConfirmed kullanılıyor.
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                tr('orders.convert_to_purchase_title'),
                                style: TextStyle(
                              ...
                              Text(
                                '${tr('orders.order_no')}: ${widget.siparis.id}',
                                style: TextStyle(
                          ...
                          (context, controller, focusNode, onFieldSubmitted) {
                            ...
                            return TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: tr('orders.search_customer_hint'),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Text(
                                tr('orders.convert_to_purchase_btn'),
                                style: const TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w700,
                                ),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          tr('orders.select_customer_to_convert'),
                          style: TextStyle(
                        ...
                        Text(
                          tr('orders.search_customer_hint'),
                          style: TextStyle(
